const articles = [
    {
        id: 1,
        photo: require('../assets/articles/photo1.png'),
        type: 'article',
        time: -300,
    ...
    {
        id: 2,
        photo: require('../assets/articles/photo2.png'),
        type: 'article',
        time: -1373,
        header: 'Balloon Trip',
    ...
    {
        id: 3,
        photo: require('../assets/articles/photo3.png'),
        type: 'article',
        time: -2446,
        header: 'Sea World',
    ...
    {
        id: 4,
        photo: require('../assets/articles/photo4.png'),
        type: 'article',
        time: -3519,
        header: 'Flowers',
    ...
    {
        id: 5,
        photo: require('../assets/articles/photo5.png'),
        type: 'article',
        time: -4592,
    ...
    {
        id: 6,
        photo: require('../assets/articles/photo6.png'),
        type: 'article',
        time: -5665,
        header: 'Mountains',
    ...
    {
        id: 7,
        photo: require('../assets/articles/photo45.png'),
        type: 'fact',
        time: -5665,
    ...
    {
        id: 8,
        photo: require('../assets/articles/photo46.png'),
        type: 'fact',
        time: -8373,
    ...
    {
        id: 9,
        photo: require('../assets/articles/photo47.png'),
        type: 'fact',
        time: -565,
        header: 'Elephant',
    ...
    {
        id: 10,
        photo: require('../assets/articles/photo48.png'),
        type: 'fact',
        time: -52365,
        header: 'Cold Water',
    ...
    {
        id: 11,
        photo: require('../assets/articles/photo49.png'),
        type: 'fact',
        time: -1295,
        header: 'Our Eyes',
    ...
    {
        id: 12,
        photo: require('../assets/articles/photo17.png'),
        type: 'post',
        time: -300,
    ...
    {
        id: 13,
        photo: require('../assets/articles/photo18.png'),
        type: 'post',
        time: -1373,
        header: 'Interesting Fact',
    ...
    {
        id: 14,
        photo: require('../assets/articles/photo19.png'),
        type: 'post',
        time: -2446,
    ...
    {
        id: 15,
        photo: require('../assets/articles/photo20.png'),
        type: 'post',
        time: -3519,
